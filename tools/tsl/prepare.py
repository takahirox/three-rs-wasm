...
with tarfile.open(ROOT/f'.cache/three-{COMMIT}.tar.gz') as tar:
    ...
    for path in ['examples/models/bvh/pirouette.bvh', 'examples/models/mdd/cube.mdd', 'examples/models/obj/cerberus/Cerberus.obj', 'examples/models/obj/cerberus/Cerberus_A.jpg', 'examples/models/3ds/portalgun/portalgun.3ds', 'examples/models/3ds/portalgun/textures/color.jpg', 'examples/models/3ds/portalgun/textures/normal.jpg', 'examples/models/gltf/Flower/Flower.glb', 'examples/models/gltf/Flower/README.md', 'examples/models/gcode/benchy.gcode', 'examples/models/gcode/test_m82.gcode', 'examples/models/gcode/test_m83.gcode', 'examples/models/vox/monu10.vox', 'examples/models/obj/male02/male02.obj', 'examples/models/obj/male02/male02.mtl', 'examples/models/obj/male02/01_-_Default1noCulling.JPG', 'examples/models/obj/male02/male-02-1noCulling.JPG', 'examples/models/obj/male02/orig_02_-_Defaul1noCulling.JPG', 'examples/models/obj/male02/readme.txt', 'examples/textures/memorial.hdr','examples/textures/minecraft/atlas.png','examples/textures/sprite2.png','examples/textures/water.jpg','examples/models/pcd/ascii/simple.pcd','examples/models/pcd/binary/Zaghetto.pcd','examples/models/pcd/binary/Zaghetto_8bit.pcd','examples/models/pcd/binary_compressed/pcl_logo.pcd','examples/textures/planets/earth_atmos_2048.jpg',*['examples/'+p for p in json.loads((ROOT/'tools/gallery/environment-material-paths.json').read_text())],'examples/models/json/WaltHeadLo_buffergeometry.json','examples/models/json/pressure.json','examples/textures/terrain/grasslight-big.jpg',*[f'examples/textures/sprites/{name}' for name in ['ball.png','snowflake2.png','snowflake3.png','snowflake4.png','snowflake5.png']],'examples/textures/sprites/spark1.png','examples/fonts/MPLUSRounded1c/MPLUSRounded1c-Regular.typeface.json','examples/fonts/MPLUSRounded1c/OFL.txt','examples/fonts/LICENSE','examples/textures/sprites/disc.png','examples/textures/carbon/Carbon.png','examples/textures/uv_grid_opengl.jpg','examples/textures/checker.png','examples/sounds/webgpu-audio-processing.mp3','examples/textures/floors/FloorsCheckerboard_S_Normal.jpg','examples/textures/floors/FloorsCheckerboard_S_Diffuse.jpg','examples/textures/decal/decal-diffuse.png','examples/textures/decal/decal-normal.jpg','examples/textures/equirectangular/pedestrian_overpass_1k.hdr','examples/models/gltf/gears.glb','examples/textures/equirectangular/san_giuseppe_bridge_2k.hdr','examples/textures/uv_grid_directx.jpg','examples/fonts/helvetiker_regular.typeface.json','examples/models/gltf/Xbot.glb',*[f'examples/textures/cube/angus/cube_m0{level}_c0{face}.jpg' for level in range(9) for face in range(6)],*[f'examples/textures/cube/SwedishRoyalCastle/{name}.jpg' for name in ['px','nx','py','ny','pz','nz']],*[f'examples/textures/planets/{name}' for name in ['earth_day_4096.jpg','earth_night_4096.jpg','earth_bump_roughness_clouds_4096.jpg']],'examples/textures/spiritedaway.ktx2','examples/jsm/math/ImprovedNoise.js','examples/textures/3d/head256x256x109.zip','examples/textures/sprites/blossom.png','examples/models/gltf/LeePerrySmith/LeePerrySmith_License.txt','examples/models/gltf/LeePerrySmith/LeePerrySmith.glb','examples/models/gltf/PrimaryIonDrive.glb','examples/textures/equirectangular/moonless_golf_1k.hdr','examples/textures/water/Water_1_M_Normal.jpg','examples/textures/roughness_map.jpg','examples/textures/noises/voronoi/grayscale-256x256.png','examples/textures/noises/perlin/rgb-256x256.png','examples/textures/hardwood2_diffuse.jpg','examples/models/gltf/Michelle.glb','examples/textures/opengameart/smoke1.png','examples/models/json/suzanne_buffergeometry.json','examples/textures/sprite1.png','examples/textures/sprites/snowflake1.png','examples/textures/sprites/circle.png','examples/jsm/tsl/display/AfterImageNode.js',*[f'examples/textures/transition/transition{i}.png' for i in range(1,7)], *[f'examples/jsm/tsl/display/{name}' for name in ['FXAANode.js','SSAAPassNode.js','TransitionNode.js','radialBlur.js']], 'examples/textures/planets/earth_lights_2048.png', 'examples/jsm/tsl/display/GaussianBlurNode.js', 'examples/jsm/capabilities/WebGPU.js', 'examples/jsm/tsl/display/DotScreenNode.js', 'examples/jsm/tsl/display/RGBShiftNode.js', 'examples/textures/758px-Canestra_di_frutta_(Caravaggio).jpg', 'examples/textures/crate.gif', 'examples/textures/uv_grid_opengl.jpg', 'examples/textures/2294472375_24a3b8ef46_o.jpg']:
        ...
        if path in {'examples/models/gcode/benchy.gcode': 'gcode/benchy.gcode', 'examples/models/gcode/test_m82.gcode': 'gcode/test_m82.gcode', 'examples/models/gcode/test_m83.gcode': 'gcode/test_m83.gcode', 'examples/models/vox/monu10.vox': 'vox/monu10.vox', 'examples/models/obj/male02/male02.obj': 'obj/male02/male02.obj', 'examples/models/obj/male02/male02.mtl': 'obj/male02/male02.mtl', 'examples/models/obj/male02/01_-_Default1noCulling.JPG': 'obj/male02/01_-_Default1noCulling.JPG', 'examples/models/obj/male02/male-02-1noCulling.JPG': 'obj/male02/male-02-1noCulling.JPG', 'examples/models/obj/male02/orig_02_-_Defaul1noCulling.JPG': 'obj/male02/orig_02_-_Defaul1noCulling.JPG', 'examples/models/obj/male02/readme.txt': 'obj/male02/readme.txt'}:
            ...
            target.parent.mkdir(parents=True,exist_ok=True)
            target.write_bytes(data)
        if path in {'examples/models/bvh/pirouette.bvh': 'bvh/pirouette.bvh', 'examples/models/mdd/cube.mdd': 'mdd/cube.mdd', 'examples/models/obj/cerberus/Cerberus.obj': 'obj/cerberus/Cerberus.obj', 'examples/models/obj/cerberus/Cerberus_A.jpg': 'obj/cerberus/Cerberus_A.jpg', 'examples/models/3ds/portalgun/portalgun.3ds': '3ds/portalgun/portalgun.3ds', 'examples/models/3ds/portalgun/textures/color.jpg': '3ds/portalgun/textures/color.jpg', 'examples/models/3ds/portalgun/textures/normal.jpg': '3ds/portalgun/textures/normal.jpg', 'examples/models/gltf/Flower/Flower.glb': 'gltf/Flower/Flower.glb', 'examples/models/gltf/Flower/README.md': 'gltf/Flower/README.md'}:
            target=ROOT/'web/gallery/assets'/{'examples/models/bvh/pirouette.bvh': 'bvh/pirouette.bvh', 'examples/models/mdd/cube.mdd': 'mdd/cube.mdd', 'examples/models/obj/cerberus/Cerberus.obj': 'obj/cerberus/Cerberus.obj', 'examples/models/obj/cerberus/Cerberus_A.jpg': 'obj/cerberus/Cerberus_A.jpg', 'examples/models/3ds/portalgun/portalgun.3ds': '3ds/portalgun/portalgun.3ds', 'examples/models/3ds/portalgun/textures/color.jpg': '3ds/portalgun/textures/color.jpg', 'examples/models/3ds/portalgun/textures/normal.jpg': '3ds/portalgun/textures/normal.jpg', 'examples/models/gltf/Flower/Flower.glb': 'gltf/Flower/Flower.glb', 'examples/models/gltf/Flower/README.md': 'gltf/Flower/README.md'}[path]
            target.parent.mkdir(parents=True,exist_ok=True)
            target.write_bytes(data)

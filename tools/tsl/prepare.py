...
with tarfile.open(ROOT/f'.cache/three-{COMMIT}.tar.gz') as tar:
    for path in ['examples/textures/sprite1.png','examples/textures/sprites/snowflake1.png','examples/textures/sprites/circle.png','examples/jsm/tsl/display/AfterImageNode.js',*[f'examples/textures/transition/transition{i}.png' for i in range(1,7)], *[f'examples/jsm/tsl/display/{name}' for name in ['FXAANode.js','SSAAPassNode.js','TransitionNode.js','radialBlur.js']], 'examples/textures/planets/earth_lights_2048.png', 'examples/jsm/tsl/display/GaussianBlurNode.js', 'examples/jsm/capabilities/WebGPU.js', 'examples/jsm/tsl/display/DotScreenNode.js', 'examples/jsm/tsl/display/RGBShiftNode.js', 'examples/textures/758px-Canestra_di_frutta_(Caravaggio).jpg', 'examples/textures/crate.gif', 'examples/textures/uv_grid_opengl.jpg', 'examples/textures/2294472375_24a3b8ef46_o.jpg']:
        ...
        if '/transition/' in path or path in ['examples/textures/sprite1.png','examples/textures/sprites/snowflake1.png','examples/textures/sprites/circle.png']:

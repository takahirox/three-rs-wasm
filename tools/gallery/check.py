...
for record in json.loads((ROOT/"web/gallery/assets/interactive-objects-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/interactive-scenes-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/views-loaders-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/stereo-loaders-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/controls-attributes-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/trackball-sprites-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/terrain-loaders-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/models-modifiers-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/picking-buffers-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/helpers-formats-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/refraction-loaders-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/shapes-lights-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/text-clipping-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/exporters-matcap-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/sky-water-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/lights-probes-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/exporters-video-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/shadow-rtt-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/probes-hdr-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/passes-decals-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/draco-variants-manifest.json").read_text())+json.loads((ROOT/"web/gallery/assets/texture-flares-manifest.json").read_text()):
 assert hashlib.sha256((ROOT/"web/gallery/assets"/record["file"]).read_bytes()).hexdigest()==record["sha256"]
 assert hashlib.sha256((ROOT/".cache/three-r186"/record["source"]).read_bytes()).hexdigest()==record["sha256"]

...
2 excluded for explicit WebGL APIs; 605 retained. 33 partial Rust ports; 572 not yet ported. Only runnable ports appear in the gallery list. No complete-gallery reproduction claim.

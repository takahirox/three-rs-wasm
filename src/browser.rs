...
impl State {
    ...
    fn render(&mut self, time: f64) -> Result<()> {
        ...
        let format = if [
            ...
            258, 259, 260, 265, 273, 274, 277, 278, 279, 280, 281, 282,
        ]
                ...
                if example >= 4 {
                    RenderTargetOptions {
                        samples: if [
                            ...
                            248, 257, 262, 263, 267, 269, 277, 278, 280, 281, 282,
                        ]
                        .contains(&example)
                        {
                            1
                        ...
                        encode_srgb: [
                            ...
                            259, 260, 265, 273, 274, 277, 278, 279, 280, 281, 282,
                        ]
                        .contains(&example),
                        format: if [
